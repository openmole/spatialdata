...
object APIExtractor {
  ...
  object Buildings {
    ...
    def getBuildings(south: Double, west: Double, north: Double, east: Double): Seq[Polygon] = {
    ...
    def getBuildingIntersection(south: Double, west: Double, north: Double, east: Double): Seq[Geometry] = {
